...
<body>
    ...
    <div  
        style="height: 1134px; width: 1435px; background-color: #C0C0C0;">
        ...
        <asp:Panel ID="Panel2" runat="server" BackColor="#FFFF99" 
            ...
            <asp:LinkButton ID="LinkButton3" runat="server" 
                ...
                Font-Size="X-Large" onclick="LinkButton3_Click">SignUp</asp:LinkButton>
        </asp:Panel>
        <br />
        ...
        <asp:Panel ID="Panel3" runat="server" BackColor="#FFFF99" 
            ...
            style="top: 145px; left: 17px; position: absolute; height: 971px; width: 1386px">
            ...
            <asp:LinkButton ID="LinkButton4" runat="server" 
                style="position:absolute; top: -54px; left: 351px; height: 28px; width: 79px;" 
                Font-Bold="True" Font-Italic="True" Font-Names="Gill Sans MT Condensed" 
                Font-Size="X-Large" onclick="LinkButton4_Click">Login</asp:LinkButton>
        </asp:Panel>
